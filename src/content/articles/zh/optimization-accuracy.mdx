...
| **结构化剪枝** | SparseGPT, Wanda | 10-50% 稀疏: 1-5% | 高稀疏率下非线性退化 |
...
# GPTQ 量化模型
lm_eval --model hf \
  --model_args pretrained=TheBloke/Llama-3.1-8B-Instruct-GPTQ \
  --tasks mmlu,gsm8k,humaneval \
  --device cuda:0 \
  --batch_size auto
...
3. **temperature 设置**：HumanEval 的 pass@k 对 temperature 极其敏感。pass@1 通常用 temperature=0，pass@10 用 0.8
...
quantization_config = nncf.QuantizationConfig(
    mode=nncf.QuantizationMode.INT8,
    # 精度损失不超过 1%
    max_drop=0.01,
