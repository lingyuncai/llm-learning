...
作为较早期的模型，Mistral 7B 报告的 benchmark 最少——仅有 MMLU (62.5%)、ARC-C (78.5%) 和 HumanEval (32.9%)。大量"N/R"反映了 Mistral 7B 发布时（2023 年 9 月）benchmark 标配集尚未形成。这也说明了标配集的**时间演变**：2023 年不需要报的分数，2024 年已经成为必报项。
