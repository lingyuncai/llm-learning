...
A notable 2026 development is using **small language models themselves** for routing. Small Models, Big Decisions (2026) proposes: since 1–4B parameter small LMs already possess considerable semantic understanding, why not have them directly judge query difficulty?
