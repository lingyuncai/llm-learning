...
This seemingly simple rule fundamentally changed compiler design. SSA was systematized by Cytron et al. in their 1991 landmark paper "Efficiently Computing Static Single Assignment Form and the Control Dependence Graph," and has since become the standard IR form for virtually all modern compilers — LLVM IR, GCC GIMPLE, Java HotSpot's Sea of Nodes, V8's TurboFan, without exception.
...
MLIR (Multi-Level Intermediate Representation) was initiated by Chris Lattner at Google, with the paper "MLIR: Scaling Compiler Infrastructure for Domain Specific Computation" published in 2020. Its core innovation is:
...
- Lattner et al., "MLIR: Scaling Compiler Infrastructure for Domain Specific Computation" (2020) — The MLIR design paper, explaining the motivation and implementation of multi-level IR and the Dialect system
