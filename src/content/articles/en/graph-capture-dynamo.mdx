...
references:
  ...
  - type: website
    title: "AOT Autograd — How to use and optimize?"
    url: "https://pytorch.org/functorch/stable/notebooks/aot_autograd_optimizations.html"
---
...
2. **Trace backward computation**: Use the `__torch_dispatch__` mechanism to intercept autograd engine operations, extracting operator-level computation graphs for both forward and backward passes
...
- [AOT Autograd — How to use and optimize?](https://pytorch.org/functorch/stable/notebooks/aot_autograd_optimizations.html) — AOTAutograd usage and optimization tutorial
