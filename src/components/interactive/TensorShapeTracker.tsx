  ...
  const t = {
    zh: {
      ...
      stages: [
        ...
        { label: 'reshape', simpleShape: '(S, d_k)', fullShape: '(B, h, S, d_k)', desc: 'reshape + transpose 拆分多头。Q/K → d_k 维，V → d_v 维（标准 Transformer 中 d_k = d_v）' },
        ...
        { label: '× V', simpleShape: '(S, d_v)', fullShape: '(B, h, S, d_v)', desc: '加权求和 Value。输出维度由 V 的维度 d_v 决定' },
    ...
    en: {
      ...
      stages: [
        ...
        { label: 'reshape', simpleShape: '(S, d_k)', fullShape: '(B, h, S, d_k)', desc: 'reshape + transpose to split multi-heads. Q/K → d_k dim, V → d_v dim (d_k = d_v in standard Transformer)' },
        ...
        { label: '× V', simpleShape: '(S, d_v)', fullShape: '(B, h, S, d_v)', desc: 'Weighted sum of Values. Output dimension determined by V\'s dimension d_v' },
